    ...
    public void addSampleMovies() {
        if (experienceRepository.findAll().isEmpty()) {
            List<Experience> experiences = List.of(
                    new Experience("Experiencia 1: Paseo en bicicleta por el Montseny",
                    ...
                    new Experience("Experiencia 2: Descubre la costa en barco de vela",
                    ...
                    new Experience("Experiencia 3: Descubre la Barcelona Modernista de noche",
                    ...
                    new Experience("Experiencia 4: Del huerto a la mesa",
                    ...
                    new Experience("Experiencia 5: Arte en la montaña sagrada ",
