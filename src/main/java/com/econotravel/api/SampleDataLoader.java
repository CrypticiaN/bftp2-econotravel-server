        ...
        if (experienceRepository.findAll().isEmpty()) {
            List<Experience> experiences = List.of(
                    new Experience("Paseo en bicicleta por el Montseny",
                            ...
                            250,
                            "5h",
                            "Actividad disponible para todas las edades. Disponemos de bicicletas accesibles para personas con movilidad reducida en el tren inferior así como sillines con capacidad para niños menores de 5 años (peso máximo 20kg).", "https://buy.stripe.com/5kA2a68w47tp0yk28f",
                    ...
                    new Experience("Descubre la costa en barco de vela",
                            ...
                            280,
                            "4h",
                            "Actividad disponible para todas las edades. Pasarela para silla de ruedas disponible bajo reserva.", "https://buy.stripe.com/cN26qmbIg00X4OAbIO",
                    ...
                    new Experience("Del huerto a la mesa",
                            ...
                            145,
                            "3h",
                            "Actividad disponible para todas las edades. El acceso al huerto en silla de ruedas está garantizado.", "https://buy.stripe.com/aEUdSOh2A6pldl66os",
